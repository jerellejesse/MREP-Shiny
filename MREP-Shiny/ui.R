...
body <- dashboardBody(
  tabItems(
    tabItem(
      ...
      h2("An Interactive Tool for Stock Assessment",
        fluidRow(tabBox(title = "", width = 10, id = "tabset1",
          tabPanel("About"),
          tabPanel("Stock Info"),
          tabPanel("Glossary")
        ))
    ...
    tabItem(
      ...
      h2("Assessment Input/Output Exploration",
         fluidRow(
                  box(width=3,
                      radioButtons("Inputs", "Assessment Inputs",
                                  c("Input 1"="1",
                                    "Input 2"="2",
                                    "Input 3"="3",
                                    "Input 4"="4"))),
         ...
         fluidRow(
           box(width=3,
               radioButtons("Outputs", "Assessment Results",
                            c("Output 1"="1",
                              "Output 2"="2",
                              "Output 3"="3",
                              "Output 4"="4"))),
    ...
    tabItem(
      ...
      h2("See what changes under different scenarios",
         fluidRow(
           box(width=3,
    ...
    tabItem(
      ...
      h2("Choose scenario and compare",
         fluidRow(
           box(width=3,
               checkboxGroupInput("scenario", "Scenarios saved from last tab",
                            c("Scenario 1"="1",
                              "Scenario 2"="2",
                              "Scenario 3"="3",
                              "Scenario 4"="4"))),
